...
def prepare_input(TIMESTEP_solv:str, dest:str,CO2_path:str,  template_path:str, forcings_path, input_path:str, input_name:str) -> None:
    ...
    split_climate(time_step=TIMESTEP_solv, ds_files, CO2FILE=CO2_path,  dt=100, ds_path=os.path.join(forcings_path, 'climdata'),
                                    dest_path=os.path.join(input_path, 'input',
                                        'climdata'))
