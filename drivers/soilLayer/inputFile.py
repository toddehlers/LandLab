...
ssT    = 15.e6  #spin-up time before sin-modulation, set to same value as totalT for steady-state-simulations
sfT    = 7.e6  #spin-up time before step-change-modulation, set to same value as totalT for steady-state-simulations
dt = 100
...
#Surface Processes
#Linear Diffusion:
soilCreepEfficienyBase = 2e-1 #m/s
...
soilProductionDepth = 1

#Climate Parameters
baseRainfall = 40 #m/dt, base steady-state rainfall-mean over the dt-timespan
...
stepChangeVegi = 0 #vegetation cover step change amplitude
