...
baseElevation = 400 #base elevation extracted from 30m ASTER DEM
...
soilProductionRate = 0.0042 #m/yr
...
LPJGUESS_FORCINGS_STRING = 'LaCampana_TraCE21ka' #Testing: This automatically adds the _precip.nc/_temp.nc/_rad.nc to filesnames.
