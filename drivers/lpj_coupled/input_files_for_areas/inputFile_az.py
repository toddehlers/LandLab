...
baseElevation = 220 #base elevation extracted from 30m ASTER DEM 

#Surface Processes
#Linear Diffusion:
linDiffBase = 0.001 #m2/yr, base linear diffusivity for bare-bedrock
...
soilProductionRate = 0.0006 #m/yr
...
LPJGUESS_FORCINGS_STRING = 'Azucar_TraCE21ka' #Testing: This automatically adds the _precip.nc/_temp.nc/_rad.nc to filesnames.
