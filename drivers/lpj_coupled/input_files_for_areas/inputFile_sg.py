...
baseElevation = 320 #base elevation extracted from 30m ASTER DEM

#Surface Processes
#Linear Diffusion:
linDiffBase = 0.005 #m2/yr, base linear diffusivity for bare-bedrock
...
soilProductionRate = 0.0016 #m/yr
soilProductionDecayDepth = 0.5 #m

#Climate Parameters
baseRainfall = float(6) #m/dt, base steady-state rainfall-mean over the dt-timespan
rfA          = 0 #m, rainfall-step-change if used

#Vegetation Cover
vp = .3 #initial vegetation cover, 1 = 100%
sinAmp = 0.1 #vegetation cover amplitude for oscillation
sinPeriod = 1e5 #yrs, period of sin-modification

#LPJ_coupling_parameters:
latitude   = -29.75 #center-coordinate of grid cell for model area
...
LPJGUESS_FORCINGS_STRING = 'SantaGracia_TraCE21ka' #Testing: This automatically adds the _precip.nc/_temp.nc/_rad.nc to filesnames.
